...
if ( ! isset ($_POST ["txtPseudo"]) == true && ! isset ($_POST ["txtAdresseMail"]) == true) {
    ...
    if ( empty ($_POST ["txtPseudo"]) == true && empty ($_POST ["txtAdresseMail"]) == true) 
        $pseudo = "";
        $adresseMail = "";
    else   
		...
		if ( ! $dao->existePseudoUtilisateur($pseudo) && ! $dao->existePseudoUtilisateur($adresseMail))  {
