		...
		<div data-role="page" id="page_principale">
			...
			<div data-role="content">
				...
				<form action="index.php?action=DemarrerEnregistrementParcours" method="post" data-ajax="false">
					...
					<div>
						<label for="checkboxEnvoyer">Cocher pour envoyer un courriel automatique aux utilisateurs autorises.</label>
                    	<input type="checkbox" name="checkboxEnvoyer" id="checkboxEnvoyer">
                    </div>
