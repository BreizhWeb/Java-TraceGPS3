			...
			<div data-role="content">
				...
				{ ?>
    				<form name="form1" id="form1" action="index.php?action=DemanderMdp" data-ajax="false" method="post" data-transition="<?php echo $transition; ?>">
    					...
    					<div>
    						<label for="txtAdresseMail">Ainsi que votre adresse mail :</label>
    						<input type="text" name="txtAdresseMail" id="txtAdresseMail" data-mini="true" placeholder="Mon adresse mail" required>
    					</div>
